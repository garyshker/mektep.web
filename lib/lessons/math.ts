...
export function generateEquationLesson(): Lesson {
  ...
  return {
    ...
    titleByLang: { kk: 'Теңдеулер · x-ті тап', ru: 'Уравнения · найди x', en: 'Equations · find x' },
    introByLang: { kk: 'Санды теңдік арқылы көшіріп, x-ті табамыз!', ru: 'Переносим число через знак = и находим x!', en: 'Move the number across = to find x!' },
    grade: [2, 3, 4],
    questions: Array.from({ length: 8 }, make),
  }
}
...

  {
    ...
    questions: [
      ...
      { kind: 'tap', image: '📐',
        ...
        words: ['карандаш', 'автобус', 'линейка', 'Алатау', 'книга', 'поле'],
        wordsByLang: {
          kk: ['қарындаш', 'автобус', 'сызғыш', 'Алатау', 'кітап', 'дала'],
          ru: ['карандаш', 'автобус', 'линейка', 'Алатау', 'книга', 'поле'],
          en: ['pencil', 'bus', 'ruler', 'Alatau', 'book', 'field'],
        }, correctIdxs: [0, 2, 4] },
      { kind: 'mc',
      ...
      { kind: 'match', image: '📐📏',
        ...
        items: [
          { text: 'карандаш', textByLang: { kk: 'қарындаш', ru: 'карандаш', en: 'pencil' }, group: 0 },
          { text: 'комната', textByLang: { kk: 'бөлме', ru: 'комната', en: 'room' }, group: 1 },
          { text: 'палец', textByLang: { kk: 'саусақ', ru: 'палец', en: 'finger' }, group: 0 },
          { text: 'дорога', textByLang: { kk: 'жол', ru: 'дорога', en: 'road' }, group: 1 },
        ] },
    ],
  },

  {
    ...
    questions: [
      ...
      { kind: 'tap', image: '🍶💧',
        ...
        words: ['чай', 'яблоко', 'вода', 'книга', 'молоко', 'карандаш'],
        wordsByLang: {
          kk: ['шай', 'алма', 'су', 'кітап', 'сүт', 'қарындаш'],
          ru: ['чай', 'яблоко', 'вода', 'книга', 'молоко', 'карандаш'],
          en: ['tea', 'apple', 'water', 'book', 'milk', 'pencil'],
        }, correctIdxs: [0, 2, 4] },
      { kind: 'mc', image: '⚖️',
      ...
      { kind: 'match', image: '🏪',
        ...
        items: [
          { text: 'молоко', textByLang: { kk: 'сүт', ru: 'молоко', en: 'milk' }, group: 0 },
          { text: 'мука', textByLang: { kk: 'ұн', ru: 'мука', en: 'flour' }, group: 1 },
          { text: 'сок', textByLang: { kk: 'шырын', ru: 'сок', en: 'juice' }, group: 0 },
          { text: 'мясо', textByLang: { kk: 'ет', ru: 'мясо', en: 'meat' }, group: 1 },
          { text: 'бензин', textByLang: { kk: 'бензин', ru: 'бензин', en: 'petrol' }, group: 0 },
          { text: 'картошка', textByLang: { kk: 'картоп', ru: 'картошка', en: 'potatoes' }, group: 1 },
        ] },
      { kind: 'word', image: '🛍️',
...

  {
    ...
    questions: [
      ...
      { kind: 'tap',
        ...
        words: ['Квадрат', 'Треугольник', 'Ромб', 'Круг', 'Прямоугольник', 'Трапеция'],
        wordsByLang: {
          kk: ['Шаршы', 'Үшбұрыш', 'Ромб', 'Дөңгелек', 'Тіктөртбұрыш', 'Трапеция'],
          ru: ['Квадрат', 'Треугольник', 'Ромб', 'Круг', 'Прямоугольник', 'Трапеция'],
          en: ['Square', 'Triangle', 'Rhombus', 'Circle', 'Rectangle', 'Trapezium'],
        }, correctIdxs: [0, 2, 4, 5] },
      { kind: 'mc',
      ...
      { kind: 'match',
        ...
        items: [
          { text: 'Квадрат', textByLang: { kk: 'Шаршы', ru: 'Квадрат', en: 'Square' }, group: 1 },
          { text: 'Треугольник', textByLang: { kk: 'Үшбұрыш', ru: 'Треугольник', en: 'Triangle' }, group: 0 },
          { text: 'Прямоугольник', textByLang: { kk: 'Тіктөртбұрыш', ru: 'Прямоугольник', en: 'Rectangle' }, group: 1 },
          { text: 'Равносторонний △', textByLang: { kk: 'Тең қабырғалы △', ru: 'Равносторонний △', en: 'Equilateral △' }, group: 0 },
        ] },
      { kind: 'word', image: '📏',
